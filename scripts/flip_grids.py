...
with h5py.File(path, 'r+') as f:
    ...
    f['x_grid'][...] = xg.T
    f['y_grid'][...] = yg.T
    print("Transposed x_grid and y_grid in place.")
    print(f"  x_grid now varies along axis0: {np.ptp(f['x_grid'][:, 0]):.6g}")
    print(f"  y_grid now varies along axis1: {np.ptp(f['y_grid'][0, :]):.6g}")
